...
[![GoDoc](https://godoc.org/github.com/HamzaLiu/telebot?status.svg)](https://godoc.org/github.com/HamzaLiu/telebot)
...
```bash
go get -u github.com/HamzaLiu/telebot
```
...
[here](https://godoc.org/github.com/HamzaLiu/telebot#pkg-constants).
...
implementations:
```go
import "github.com/HamzaLiu/telebot/middleware"
```
...
[here](https://pkg.go.dev/github.com/HamzaLiu/telebot#Option).
